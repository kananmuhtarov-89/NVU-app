...
report["tesnifat_settings"] = {
    "merge_g":     st.session_state.get("tesnifat_merge", True),
    "calc_amounts": st.session_state.get("tesnifat_calc", False),
}
report["tesnifat_table"] = st.session_state.get("tesnifat_table")  # None ola bilər
report["tesnifat_totals"] = {
    "count":  st.session_state.get("tesnifat_total_count"),
    "amount": st.session_state.get("tesnifat_total_amount"),
}
